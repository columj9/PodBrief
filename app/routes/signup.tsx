...
type ActionData = 
  | { url: string; error?: never; message?: never }
  | { error: string; url?: never; message?: never }
  | { message: string; url?: never; error?: never };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
        ...
        {actionData?.message && (
          <div className="text-green-600 text-sm text-center">{actionData.message}</div>
        )}
